...
function Dashboard() {
  ...
  useEffect(() => {
    // تم تصحيح المسار ليتطابق مع الباك إند
    ...
    <div className="p-8 font-sans h-full overflow-y-auto bg-gray-50 dark:bg-gray-900 transition-colors" dir="rtl">
      <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
        ...
        <select 
          ...
          className="border p-2 rounded-lg bg-gray-800 text-white font-bold cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-900/40 p-6 rounded-xl border border-blue-800 text-center">
        ...
        <div className="bg-red-900/40 p-6 rounded-xl border border-red-800 text-center">
          <p className="text-red-200 font-bold mb-2">المصروفات</p>
          <h2 className="text-3xl font-bold text-red-400">₪{stats.total_expenses}</h2>
        </div>
        <div className="bg-green-900/40 p-6 rounded-xl border border-green-800 text-center">
        ...
        <div className="bg-purple-900/40 p-6 rounded-xl border border-purple-800 text-center">
            ...
            <tbody>
              {stats.recent_orders.map(order => (
                <tr key={order.id} className="border-b border-gray-700/50">
                  ...
                  <td className="py-3">{order.customer ? order.customer.name : 'زبون عابر'}</td>
